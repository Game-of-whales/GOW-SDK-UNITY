...
-(void)unitySendMethodWithString:(NSString*)method param:(NSString*)data
{
...
{
    [self unitySendMethodWithString:@"Internal_OnConnected" param: dataReceived ? @"true" : @"false"];  
}
...
- (BOOL)CanStartExperiment:(nonnull GWExperiment *)experiment {
    ...
    try
    {
        NSLog(@"GameOfWhalesProxy:CanStartExperiment");
        NSString *expStr = [experiment save];
        
        [self unitySendMethodWithString:@"Internal_CanStartExperiment" param:expStr];
        return false;
...
- (void)OnExperimentEnded:(nonnull GWExperiment *)experiment {
    try
    {
        NSLog(@"GameOfWhalesProxy:OnExperimentEnded");
        NSString *expStr = [experiment save];
        [self unitySendMethodWithString:@"Internal_OnExperimentEnded" param:expStr];
    }
    catch (...) {
        NSLog(@"GameOfWhalesProxy:OnExperimentEnded");
    }
...
extern "C" {
    void gw_initialize(const char* gameKey, const char* listenerName, const char* version, bool debug, bool nonPersonal)
    {
        try
        {
            ...
            [GW SetCanExperimentStartDelay: true];
            ...
            NSLog(@"GameOfWhalesProxy:gw_initialize EXCEPTION");
        }
    }
    ...
    void gw_acquire(const char* currency, const char* amount, const char* source, const char* number, const char* place)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_acquire EXCEPTION");
        }
    }
    ...
    void gw_consume(const char* currency, const char* number, const char* sink, const char* amount, const char* place)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_converting EXCEPTION");
        }
    }
    ...
    void gw_profile(const char* params)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_profile EXCEPTION");
        }
    }
    ...
    void gw_updateToken(const char* token, const char* provider)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_updateToken EXCEPTION");
        }
    }
    ...
    void gw_purchase(const char *product, const char *currency, double price)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_purchase EXCEPTION");
        }
    }
    ...
    void gw_inAppPurchased(const char* sku, double price, const char* currency, const char* transactionID, const char* receipt)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_inAppPurchased EXCEPTION");
        }
    }
    ...
    void gw_reportError(const char* message, const char* stacktrace)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_reportError EXCEPTION");
        }
    }
    ...
    void gw_loadAd()
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_loadAd EXCEPTION");
        }
    }
    ...
    bool gw_isAdLoaded()
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_isAdLoaded EXCEPTION");
        }
        return false;
    }
    ...
    void gw_pushReacted(const char* camp)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_pushReacted EXCEPTION");
        }
    }
    ...
    char* gw_cStringCopy(const char* string)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_cStringCopy EXCEPTION");
        }
        return NULL;
    }
    
    char * gw_getCurrentExperiment()
    {
        try {
            
            GWExperiment * exp = [GW GetCurrentExperiment];
            
            if (exp != NULL)
            {
                NSString* data =  [exp save];
                return gw_cStringCopy([data UTF8String]);
            }
            
        } catch (...) {
            NSLog(@"GameOfWhalesProxy:gw_getCurrentExperiment EXCEPTION");
        }
    ...
    char * gw_getProperties()
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_getProperties EXCEPTION");
        }
        return NULL;
    }
    ...
    char * gw_getServerTime()
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_getServerTime EXCEPTION");
        }
        
        return NULL;
    }
    
    void gw_setDelayedExperimentStartAnswer(bool value)
    {
        try {
            [GW SetDelayedExperimentStartAnswer:value];
        } catch (...) {
            NSLog(@"GameOfWhalesProxy:gw_setDelayedExperimentStartAnswer EXCEPTION");
        }
    }
    ...
    void gw_setPushNotificationsEnable(bool value)
    {
        try
        {
            ...
            NSLog(@"GameOfWhalesProxy:gw_setPushNotificationsEnable EXCEPTION");
        }
    }
}
