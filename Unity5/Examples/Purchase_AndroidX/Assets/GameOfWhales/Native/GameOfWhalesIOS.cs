...
public class GameOfWhalesIOS : GameOfWhales{
    ...
    [System.Runtime.InteropServices.DllImport("__Internal")]
    extern static private void gw_setDelayedExperimentStartAnswer(bool value);
    
    [System.Runtime.InteropServices.DllImport("__Internal")]
    extern static private string gw_getCurrentExperiment();
    ...
    protected override Experiment _GetCurrentExperiment()
    {
        try
        {
            string result = gw_getCurrentExperiment();
    ...
    protected override void _CallStringResult(string result)
    {
        try
        {
            gw_setDelayedExperimentStartAnswer(Boolean.Parse(result));
        }
        catch (Exception e)
        {
            Debug.LogException(e, this);
