...
extern "C" {
    ...
    void gw_acquire(const char* currency, long amount, const char* source, long number, const char* place)
    {
    ...
    void gw_consume(const char* currency, long number, const char* sink, long amount, const char* place)
    {
        NSString *nsCurrency = [[NSString alloc] initWithUTF8String:currency];
